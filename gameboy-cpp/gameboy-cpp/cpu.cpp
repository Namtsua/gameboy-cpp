...
void CPU::cycle()
{
	...
	case 0x78:	case 0x79:	case 0x7A:	case 0x7B:	case 0x7C:	case 0x7D:	case 0x7F:	// LD A, <reg>
		LD_REG_REG(static_cast<Register>(opcode >> 3 & 0x7), static_cast<Register>(opcode & 0x7));
		break;
	...
	case 0x88:	case 0x89:	case 0x8A:	case 0x8B:	case 0x8C:	case 0x8D:	case 0x8F:	// ADC A, <reg>
		// handle carry flag
		ADD_REG_REG(R_A, static_cast<Register>(opcode & 0x7));
		break;
